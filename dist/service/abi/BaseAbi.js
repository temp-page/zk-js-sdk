...
class BaseAbi {
    constructor(connectInfo, address, abi) {
        ...
        if (connectInfo.writeState) {
            this.contract = new ethers_1.Contract(address, abi, connectInfo.getWallet());
        }
        else {
            this.contract = new ethers_1.Contract(address, abi, connectInfo.getProvider());
        }
    }
}
