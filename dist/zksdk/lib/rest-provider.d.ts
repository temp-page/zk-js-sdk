...
import { AddLiquidity, ChangePubKey, CurveCombineSwap, Network, RemoveLiquidity, Tokens, ViewAddLiquidity, ViewBaseSwap } from './types';
...
export declare class RestProvider extends SyncProvider {
    ...
    constructor(address: string, curveBaseUrl: string, chainId: number);
    static newProvider(address: string, chainId: number, tokensBySymbol: Tokens, pollIntervalMilliSecs?: number, network?: Network): Promise<RestProvider>;
    parseResponse<T>(response: Response<T>, zk?: boolean): T;
    ...
    addLiquidityView(addLiquidity: ViewAddLiquidity): Promise<string>;
    addLiquidity(addLiquidity: AddLiquidity): Promise<Transaction>;
    removeLiquidity(removeLiquidity: RemoveLiquidity): Promise<Transaction>;
    swapView(requestBody: ViewBaseSwap): Promise<string>;
    curveSwap(requestBody: CurveCombineSwap): Promise<Transaction>;
    curveChangePubKey(requestBody: ChangePubKey): Promise<Transaction>;
