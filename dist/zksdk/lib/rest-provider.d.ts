...
import { AddLiquidity, ChangePubKey, CurveBaseSwap, CurveCombineSwap, Network, RemoveLiquidity, Tokens } from './types';
...
export declare class RestProvider extends SyncProvider {
    ...
    curveBaseSwap(requestBody: CurveBaseSwap): Promise<Transaction>;
    curveCombineSwap(requestBody: CurveCombineSwap): Promise<Transaction>;
