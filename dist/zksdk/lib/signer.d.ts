...
import { Address, EthSignerType, PubKeyHash, Transfer, Withdraw, ForcedExit, ChangePubKey, MintNFT, WithdrawNFT, ChangePubKeyOnchain, ChangePubKeyECDSA, ChangePubKeyCREATE2, Create2Data, Swap, Order, ChangePubKeyEIP712, AddLiquidity, RemoveLiquidity, CurveBaseSwap, CurveCombineSwap } from './types';
...
export declare class Signer {
    ...
    signAddLiquidity(transactionData: AddLiquidity): Promise<AddLiquidity>;
    signRemoveLiquidity(transactionData: RemoveLiquidity): Promise<RemoveLiquidity>;
    signCurveBaseSwap(transactionData: CurveBaseSwap): Promise<CurveBaseSwap>;
    signCurveCombineSwap(transactionData: CurveCombineSwap): Promise<CurveBaseSwap>;
