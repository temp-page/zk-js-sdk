...
import { PubKeyHash, TokenAddress, TokenLike, Tokens, TokenSymbol, EthSignerType, Address, Transfer, ForcedExit, ChangePubKey, Withdraw, CloseAccount, MintNFT, Order, Swap, TokenRatio, WeiRatio, WithdrawNFT, AddLiquidity, RemoveLiquidity, CurveBaseSwap, CurveCombineSwap } from './types';
import ERC20_DEPOSIT_GAS_LIMIT from '../misc/DepositERC20GasLimit.json';
export { ERC20_DEPOSIT_GAS_LIMIT };
...
export declare function serializeAddLiquidity(addLiquidity: AddLiquidity): Uint8Array;
export declare function serializeRemoveLiquidity(removeLiquidity: RemoveLiquidity): Uint8Array;
export declare function serializeCurveBaseSwap(curveBaseSwap: CurveBaseSwap): Uint8Array;
export declare function serializeCurveCombineSwap(curveCombineSwap: CurveCombineSwap): Uint8Array;
...
export declare function getDomain(chainId: number): {
    name: string;
    version: string;
    chainId: number;
};
export declare function changePubKeyEIP712Types(): {
    ChangePubKey: {
        name: string;
        type: string;
    }[];
