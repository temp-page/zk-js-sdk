...
export interface ViewAddLiquidity {
    accountId: number;
    amounts: string[];
...
export interface CurveBaseSwap extends BaseSwap {
}
export interface CurveCombineSwap extends BaseSwap {
}
...
export interface ApiConfig {
    network: Network;
    contract: Record<number, Address>;
    govContract: Record<number, Address>;
