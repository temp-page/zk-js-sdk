...
import { Address, ChangePubKey, ChangePubKeyCREATE2, ChangePubKeyECDSA, ChangePubKeyOnchain, ChangePubkeyTypes, Create2Data, EthSignerType, ForcedExit, MintNFT, NFT, Nonce, Order, PubKeyHash, SignedTransaction, Swap, TokenLike, TokenRatio, Transfer, TxEthSignature, WeiRatio, Withdraw, WithdrawNFT } from './types';
...
export declare class Wallet extends AbstractWallet {
    _ethSigner: ethers.Signer & TypedDataSigner;
    private _ethMessageSigner;
    signer?: Signer;
    ethSignerType?: EthSignerType;
    protected constructor(_ethSigner: ethers.Signer & TypedDataSigner, _ethMessageSigner: EthMessageSigner, cachedAddress: Address, signer?: Signer, accountId?: number, ethSignerType?: EthSignerType);
    static fromEthSigner(ethWallet: ethers.Signer & TypedDataSigner, provider: SyncProvider, signer?: Signer, accountId?: number, ethSignerType?: EthSignerType): Promise<Wallet>;
    static fromCreate2Data(syncSigner: Signer, provider: SyncProvider, create2Data: Create2Data, accountId?: number): Promise<Wallet>;
    static fromEthSignerNoKeys(ethWallet: ethers.Signer & TypedDataSigner, provider: SyncProvider, accountId?: number, ethSignerType?: EthSignerType): Promise<Wallet>;
    static fromSyncSigner(ethWallet: ethers.Signer & TypedDataSigner, syncSigner: Signer, provider: SyncProvider, accountId?: number): Promise<Wallet>;
    ethSigner(): ethers.Signer & TypedDataSigner;
    ...
    curveSwap(type: 'base' | 'combine', param: {
        poolAccountId: number;
        tokenIn: number;
        tokenOut: number;
        vin: string;
