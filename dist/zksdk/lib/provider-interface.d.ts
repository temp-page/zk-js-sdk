import { AccountState, Address, ContractAddress, Fee, IncomingTxFeeType, PriorityOperationReceipt, TokenLike, Tokens, TransactionReceipt, TxEthSignature, TxEthSignatureVariant, NFTInfo, Toggle2FARequest, Network, AddLiquidity, RemoveLiquidity, CurveBaseSwap, CurveCombineSwap, ChangePubKey } from './types';
...
export declare abstract class SyncProvider {
    ...
    abstract curveBaseSwap(result: CurveBaseSwap): Promise<Transaction>;
    abstract curveCombineSwap(result: CurveCombineSwap): Promise<Transaction>;
